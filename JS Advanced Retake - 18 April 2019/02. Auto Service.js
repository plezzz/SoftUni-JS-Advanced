...
autoService.signUpForReview('Gosho', 'AA4321AA', {'engine': 'MFRGG23', 'transmission': 'FF4418ZZ', 'exaustPipe': 'REMUS'});

console.log(autoService.repairCar());
console.log(autoService.carInfo('PB9999PB', 'PHILIP'));
console.log(autoService.availableSpace);
console.log(autoService.workInProgress.length);
console.log(autoService.backlogWork.length);
